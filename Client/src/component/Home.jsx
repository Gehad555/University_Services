  ...
  return (
    <>
        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
          <div className="container-fluid" style={{ padding: "0 50px" }}>
            ...
            <div className="collapse navbar-collapse justify-content-around" id="navbarSupportedContent">
              <div
                id={style.linkId}
                className="d-flex flex-column flex-md-row align-items-center justify-content-center gap-5 text-center"
              >
                <Link>Home</Link>
                <Link>About Us</Link>
      ...
      <div className={style.content}>
        ...
        <div className="d-flex border-top mt-5 border-black">
          <div className="im">
            <img src="faculty-image-removebg-preview.png" alt="" />
          </div>
          <div className="m">
            <p>about us</p>
            <div className="d">
              <i className="fa-brands fa-linkedin"></i>
              <p>(6) Ehab Yousef | LinkedIn</p>
            </div>
            <div className="d">
              <i className="fa-brands fa-linkedin"></i>
              <p>(6) Ehab Yousef | LinkedIn</p>
          ...
          <div className="e">
            ...
            <div className="d">
              ...
              <p>(+2064) 3223007-(+2064) 32001258</p>
            </div>
            <div className="d">
              <i className="fa-regular fa-envelope"></i>
              <p>President-office@suez.edu.eg</p>
            </div>
            <div className="d">
              <i className="fa-solid fa-location-dot"></i>
              <p>4.5 Km the Ring Road, Ismailia, Egypt</p>
            </div>
            <div className="d">
